...
const Category = () => {
    return (
        <div className='lg:container mx-auto '>
            <h1 className='mt-40 lg:mt-0 font-semibold text-[25px] text-center'>CATEGORY</h1>
            <h3 className='text-[40px] font-bold text-center mt-1 mb-[90px]'>We Offer Best Services</h3>

            <div className='grid md:grid-cols-2 lg:grid-cols-4  justify-between'>
                <div className='mx-auto w-[161px] h-[229px] mt-11 text-center'>
                ...
                <div className='mx-auto w-[267px] h-[314px] rounded-3xl bg-slate-50 text-center z-10'>
                ...
                <div className='mx-auto w-[161px] h-[229px] mt-12 text-center'>
                ...
                <div className='mx-auto w-[161px] h-[229px] mt-12'>
            ...
            <img className='hidden lg:block mt-[-68px] ml-[391px] z-0' src="/src/images/Rectangle 157.png" alt="" />
        </div>
    );
};
